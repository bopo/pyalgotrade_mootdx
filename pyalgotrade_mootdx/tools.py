...
from pyalgotrade_mootdx import barfeed
...
def build_feed(instruments, fromYear, toYear, storage, frequency=bar.Frequency.DAY, timezone=None, skipErrors=False):
    """Build and load a :class:`pyalgotrade.barfeed.mootdxfeed.Feed` using CSV files downloaded from Google Finance.
    ...
    :rtype: :class:`pyalgotrade.barfeed.mootdxfeed.Feed`.
    """

    logger = pyalgotrade.logger.getLogger("mootdx")
